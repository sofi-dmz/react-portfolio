...
function agregar_js_filtrado_sucursales() {
  wp_enqueue_script('filtrado-sucursales', get_template_directory_uri() . '/js/filtrado-sucursales.js', array('jquery'), '1.0', true);
}
add_action('wp_enqueue_scripts', 'agregar_js_filtrado_sucursales');
